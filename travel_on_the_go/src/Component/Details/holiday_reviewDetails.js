...
class HolidayReviewDetails extends Component {
    ...
    render(){
            ...
            <Header/>
                <div className="maincontainer2">  
                        ...
                        <div className="row">
                            ...
                            <div className="col md 2">
                               {this.state.GST = 0.5 * reviewdetails.price}
                        ...
                        <br/>
                            ...
                            <div className="col md 2">
                                Rs.{
                                    ...
                                    this.state.total = reviewdetails.price+this.state.GST
                                }
        ...
        <div className="traveller" style={{paddingTop:'0%',paddingLeft: '5%',marginTop:'27%'}}>
            <div className="card w-100">
